...
| Score | What It Looks Like |
| :---: | :---- |
| −3 | You're squatting somewhere that isn't yours and everyone knows it. Rivals are actively moving to take even that. |
| −2 | You have a room or a corner of a building, but it's contested. Someone else considers it theirs. They might be raccoons. |
| −1 | You have a place, but it's cramped, exposed, or in a location nobody else wanted. Rivals sniff around regularly. |
| +0 | A modest, defensible space. A house, a floor of a building, a warehouse. Unremarkable but functional. |
| +1 | A comfortable property with some breathing room. Neighbors and rival Kindred know it's yours. |
| +2 | A significant chunk of real estate; a block, a building complex, a stretch of waterfront. Other Kindred respect the boundary. |
| +3 | A whole neighborhood or borough answers to your Coterie. You are a landmark on the local Kindred political map. |

## Currency Table

| Score | What It Looks Like |
| :---: | :---- |
| −3 | You owe dangerous people real money. The kind of debt that gets kneecaps rearranged, mortal or otherwise. |
| −2 | Broke and in the hole. Can't cover emergencies. Pawning or stealing things to keep the lights on. Off is fine too, actually. |
| −1 | Scraping by. You can eat (figuratively) but a single unexpected expense is a crisis. Sound familiar? |
| +0 | Stable. Bills get paid, gear gets maintained, nobody's starving. No luxuries. Not even overnight shipping. |

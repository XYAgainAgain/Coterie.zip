...
| **[Blood Sorcery](../disciplines/blood-sorcery.md)** | A type of blood magic that allows the practitioners to manipulate the blood, mortal or vampiric. (Rituals are an extension of this that only Tremere may access.) | [Banu Haqim](banu-haqim.md), [Tremere](tremere.md) |
...
| **[Oblivion](../disciplines/oblivion.md)** | Has two branches: one allows the user to manipulate shadows at will and the other enables necromancy or usage of spirits, though both tap into the Abyss. (Ceremonies are an extension of this.) | [Hecata](hecata.md), [Lasombra](lasombra.md) |

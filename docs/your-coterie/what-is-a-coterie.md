---
title: "What is a Coterie?"
---

A "Coterie", for which this game is named, is a small group of vampires (and/or compatibly similar creatures) who share a Haven, pool their resources, and try not to tear each other to shreds long enough to survive another night. That's the short version. The longer version involves trust, betrayal, Debt, territorial negotiation, and the tragic truth that, these nights, *en esta economía*, even apex predators need roommates.

Nobody hunts alone forever. Solo vamps get picked off by hunters, muscled out by rivals, or simply lose their minds from centuries of isolation (and an unfathomable distrust of therapy). Coteries form because the alternative is worse and usually lethal. Some are genuine partnerships built on mutual respect, while others are arrangements of convenience held together by shared enemies or a landlord who doesn't ask about the blood fridge. Most are somewhere in between, shifting from one to the other depending on the night.

**Your Coterie is the unit of play in this game.** Individual character stories happen within that frame. Even if your vampire is an edgy brooding loner who trusts nobody and has a mysterious past, the game assumes you're part of a group, and that group has its own stats, its own Moves, its own reputation, and its own problems. The Coterie is a character in its own right; one that every player at the table shares responsibility for. If your character isn't willing to participate in Coterie life, make a new one that is.

**Creating your Coterie is a group activity.** You'll typically build it alongside your individual characters during Session Zero, bouncing between the two as decisions inform each other. Sit down together, talk it through, argue about it (nicely, of course), and make something that belongs to all of you. The process below will walk you through it step by step.
...
Your Coterie Type is the archetype that best describes what your group actually is and what you do together. Champions protect the neighborhood. Fixers clean up Masquerade breaches. Fang Gangs commit crimes (and have fun doing it). Nomads drift from city to city. There are 21 predefined types in [Coterie Types](coterie-types.md), plus the Uncategorizable option for groups that don't fit any of those molds.
...
For the full breakdown of what each stat means and what each score looks like in practice, see [Coterie Stats](coterie-stats.md) and the [Reference Tables](coterie-stat-reference-tables.md). Those tables are useful during creation to contextualize what +2 Charm actually feels like versus −1. Okay, next up, you'll need to...
...
If you're setting your game in a real city, you can absolutely pull up Google Maps, pick a spot, and ignore whatever's actually there. That [restaurant on the corner of Boylston Street and Park Plaza](https://maps.app.goo.gl/5QveEVjzFc8D1Tso8)? That's yours now. Have fun with it.
...
!!! tip "Guidance"
    ...
    *If you haven't completed Step 6 of character creation ([Determine Debts](../your-kindred/creating-your-character.md#6-determine-debts)) yet, this is a natural moment to do it. Note that inter-PC Debts aren't mandatory for every pair of characters. Most of your starting Debts will come from your Predator Type, Banes, or other Playbook features, and those are often external (owed to NPCs, factions, or mortals). It's actually better if most of your Debts point outward; that gives the Storyteller more to work with and keeps the Coterie from being too insular.*
...
For the full rules on how Coterie Debts work (the soft cap, creating new ones, cashing in, and refusing), see the [Debt](../core-systems/debt.md) section. If you just came from there, hi!

...
Many Rituals don't involve rolls, but some do. Each will tell you what it needs, what it does, and how you pay for it. You must gather the ingredients, spend the time, get hungrier, and if all goes well, the effect takes hold. A few Rituals defer their roll to the moment of activation, meaning you won't know if your work paid off until it matters most. For details on how to learn Rituals, see the Discipline [General Rules](general-rules.md).

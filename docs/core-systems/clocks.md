...
**Why Use Clocks?**
Because not everything resolves in a single roll! Sometimes threats build slowly, projects take time, or situations gradually worsen. Clocks let the players see (and the characters feel) how close something is to happening.

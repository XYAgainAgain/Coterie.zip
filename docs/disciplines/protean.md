...
*If you also have Blood Sorcery:* you can deliver any Blood Sorcery Power that normally requires the target to consume your Vitae through this bite instead.
...
- **BP 4:** Apex predators: wolf, hyena, cobra/anaconda, big cat, shark, etc.
- **BP 5:** Nightmares: cockatrice, three-headed hellhound, vampire bat swarm, flaming steed; whatever your Beast dreams up (these forms are overtly supernatural and are clear, unambiguous, automatic Masquerade breaches)

**On a 10+,** it's a seamless shift. You gain the animal's natural capabilities (senses, movement, natural weapons) and can use any Discipline that doesn't require speech or hands. **On a 7–9,** you still shift, but the Storyteller chooses 1 complication:

- A telltale detail is wrong: red eyes, wrong size, unnatural behavior, body part from another animal
- The shift was noisy or slow enough to draw unwanted attention
- You lose access to one of your Disciplines while transformed (Storyteller's choice)

**On a 6-,** the Storyteller makes a Move that interrupts or inhibits your transformation. You don't shift, or worse, you don't *finish* shifting.

### *The False Sip (Passive)*
...
- **Osseous Weapons:** Grow bone spurs or cartilaginous blades, gaining +1 Harm to unarmed attacks (stacks with ***Feral Weapons***)
- **Subdermal Armor:** Reinforce your frame with bony plating, granting you always-active 1-Armor
- **Redistribution:** Shift muscle and bone for raw power or agility — swap the modifiers of two stats of your choice until the night ends; if you have BP 4+, you may also raise your lowest or highest stat by +1 for the duration of one scene of your choice that night
- **Swift Form:** Elongate your limbs, grow skin flaps, or go digitigrade to move one additional Range band per turn
- **Reshape:** Alter face, build, height, skin, or voice; hide your identity, try to mimic someone specific, or get creative

**Complications:**

- You gain +1 Hunger
- You have Disadvantage on your next 3 rolls as your body adjusts
- An unwanted witness catches the transformation
- One major detail comes out wrong (Storyteller's choice)
...
- Something's visible on the surface: a hand, your outline, a faint impression
...
**On a 10+,** you absorb a number of bodies up to your Blood Potency, slaking 1 Hunger for each. The cleanup is thorough but not perfect; faint stains or residue remain. It's a tough job, but someone's gotta do it.

**On a 7–9,** you absorb only 1 body and slake 1 Hunger. The Storyteller chooses 1 complication:

- The absorption is extra messy; visible trails of blood lead back to you
- The process takes longer than expected and someone is about to walk in on– *OH NO!*
- Something about the body doesn't sit right; you still slake the Hunger but take −1 Forward from nausea (yes, vampires can get nauseous, and no, you don't want to know what happens after)

**On a 6-,** you pull the remains into you but your body rejects them violently. You slake no Hunger, and the evidence is now on you instead of on the floor. You are covered in blood, tissue, and much worse. If mortals see you right now, the Masquerade Clock advances, and also they will probably scream quite loudly.

This Power is extremely overt during use. If anyone is watching, they see a maniac absorbing a corpse through the floor like a biological vacuum cleaner. There is no subtle version of this.
...
If separated into multiple pools, your consciousness stays with the largest portion. The rest is just loose Vitae. Somebody get a mop.

**On a 10+,** the transformation is seamless. You flow freely for one scene. Only fire, sunlight, and supernatural attacks can inflict Harm upon you.

**On a 7–9,** you liquefy, but the Storyteller chooses 1 complication:

- The transformation is incomplete; one part of you stays stubbornly solid (at least you can use it!)
- You leave a conspicuous trail of blood everywhere you flow, and when you transform back, gain +1 Hunger since you left all that Vitae behind
- Reforming is sluggish and painful; it takes a full turn during which you're vulnerable and can't do anything besides agonizingly reform your body from scratch

**On a 6-,** you dissolve but can't hold yourself together. You splatter across the floor in an uncontrolled surge and must spend your next turn pulling your messy self back into a coherent mass. Anyone watching sees a person explode into blood and then frantically reassemble. If mortals are present, the Masquerade Clock advances. Gee, I wonder why.
...
The disguise lasts until you reach 5 Hunger, use this Power again, or otherwise resculpt your form through ***Vicissitude*** or similar means. You don't gain the target's clothing, knowledge, memories, or personal effects (unless you take them). You're wearing their face, not living their life. That would be crazy... right?
...
- The Beast picks an immediate target; you must **Stay Chill** or attack them
- The transformation is agonizing; take 1 Aggravated Harm
- Something extra manifests that you didn't ask for; the Storyteller decides what (and how many)

**On a 6-,** you transform, but the Beast has the wheel. You immediately reach 5 Hunger regardless of where it was before, and you Frenzy until the end of the scene. Your Coterie should get out of the way. *Now.*

### *Master of Forms (Passive)*
...
- One member's form is noticeably wrong: too large, wrong color, wonky eyes, extra head, too few/too many legs, scales/fur/feathers/skin instead of what it should be
- The magic is very taxing on you; you gain +2 Hunger
- The pack shares bestial instincts; everyone has Disadvantage on **Staying Chill** while transformed

**On a 6-,** things go horribly, horribly wrong. You and each member of your Coterie take 1 Aggravated Harm, transform into something different and very much unintended, and cannot exit the form willingly until one of the other conditions is met. You should probably seek help. If only you could talk!
...
- Your body is immune to staking. What a relief!
- Your Humanity and Stains freeze exactly where they are. You make no Remorse Checks. You cannot gain or lose Humanity by any means. Your conscience is in a box somewhere, and it can wait.
- You gain Advantage on all rolls to resist Frenzy. The Beast is still in there, but it's muffled and distant, like hearing a dog bark through several walls. Still annoying.

To reinsert your heart, you must make a number of Hunger Checks equal to your Blood Potency as your body screams its way back to wholeness. Then, you must spend at least one full scene resting and allowing your gaping chest to stitch itself shut from the inside out.

**Your heart is vulnerable!** If someone stakes your heart, you immediately enter Torpor regardless of where you are or what you're doing. It has HP equal to your Blood Potency, and it takes Aggravated Harm equal to your Blood Potency to destroy it, but only fire and sunlight will do the job. If your heart is destroyed, you meet Final Death. No exceptions. Try not to tell anyone where it is. Especially not the person you're dating.
...
- The transformation is sluggish; it takes a full turn during which you're vulnerable
...
Each turn, you deal 1 + your Blood Potency in Harm to targets within Close Range, distributed among them however you choose: all on one target, split evenly, or any combination thereof. This Harm is Aggravated against mortals and Superficial against supernatural creatures.

This Power lasts one scene or until you choose to reform, which takes your Movement if you're in combat. If even a single member of the swarm survives, you can fully regenerate into your original body at the end of the scene.

If mortals witness this, the Masquerade Clock advances. Obviously.

### *The Unfettered Heart (Passive)*
...
**On a 7–9,** the stake shifts but holds; gain +1 Hunger and try again next turn.
